...
const Main = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 mt-8 px-4 sm:px-8 max-w-7xl mx-auto w-full">
      {/* LEFT SIDE: Uploader Card */}
      <div className="group relative flex flex-col items-center justify-center w-full max-w-[36rem] min-h-[25rem] lg:h-[30rem] border-2 border-dashed border-text-secondary/30 hover:border-primary transition-all duration-700 rounded-2xl bg-surface-primary p-6 text-center">
        {/* Upload Icon Circle */}
        <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-surface-secondary flex items-center justify-center text-primary scale-100 group-hover:scale-110 transition-all duration-700">
        ...
        <div className="flex flex-col gap-2 mt-6">
          ...
          <p className="text-text-secondary text-sm sm:text-base">
            Support JPG, PNG, WEBP <span className="hidden sm:inline">|</span>{" "}
            <br className="sm:hidden" /> Max 10MB
          </p>
        </div>

        {/* Action Button */}
        <div className="mt-8 font-mono w-full sm:w-auto">
          <button className="w-full sm:w-auto bg-gradient-to-r from-primary to-[#8b84ff] text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1 transition-all flex items-center justify-center gap-2 mx-auto">
